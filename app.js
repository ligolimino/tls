(function(){
  ...
  function mediaUrl(item){return item.type==='video'?'https://www.youtube-nocookie.com/embed/'+item.id+'?autoplay=0&iv_load_policy=3&modestbranding=1&rel=0&playsinline=1&fs=0':'https://view.genially.com/'+item.id}
